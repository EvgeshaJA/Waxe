      ...
      <div class="main">
          ...
          <div class="main-navigation">
            <div class="main-navigation__form">
              <a href="#" class="main-navigation__form-link">Вход</a>
              <div class="navigation-form">
                <form id="loginForm" role="form" action="" method = "post">
                  <p class="errorLogin">Ошибка! Проверьте адрес электронной почты и пароль</p>
                  <label>E-post</label>
                  <input type="text" name="username" id="username">
                  <label>Salasõna</label>
                  <input type="password" name="password" id="password">
                  <a id="loginButton" href="#">Войти</a>
                </form>
              </div>
            </div>
            <a class="main-navigation__languige" href="index_ru.php">
              <img src="assets/img/en_flag.png" alt="image">
            </a>
          </div>
      ...
      <div class="section-footer">
        <div class="section-footer__button">
          <div class="section-footer__btn">
            <a class="section-footer__btn-link" href="https://wkk.ee/waxe" target="_blank">Онлайн-курс</a>
          </div>
        </div>
        <footer class="footer">
